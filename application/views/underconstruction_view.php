...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/templates/underconstruction/css/styles.css" rel="stylesheet" />
    </head>
    <body>
        <!-- Background Video-->
        ...
        <!-- Core theme JS-->
        <script src="<?php echo base_url(); ?>assets/templates/underconstruction/js/scripts.js"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
