...
<section class="services box">
      ...
      <!-- <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
          ...
          <tbody>
          	...
          	<tr role="row" class="odd">
                ...
                <td class=""><?php echo $dt['seq']; ?></td>
                <td style="text-align: center;">
                    <a href="<?php echo base_url('certificate_legal/cu_action/edit/'.$dt["id"].'');?>" class="fa btn btn-success fa-pencil"></a>
                </td>
            </tr>
          	<? 
          	$no++;
	...
	<div class="box-footer">
		<a href="<?php echo base_url('certificate_legal/cu_action/add');?>" class="btn btn-primary">Add</a>
	</div>
</section>
