 ...
 * @version 1.0
 * @access Public
 * @path /bintangtanjuangmadani/application/module_admin/customer/models/customer_model.php
 */
...
class Customer_model extends CI_Model {
	...
	public function get_customer($cond)
	{
		$this->db->where('is_active', 'Y');
	...
	public function get_customer_utama($id)
	{
		$this->db->where('is_active', 'Y');
		$this->db->where('id', $id);
		return $this->db->get('customer');
	...
	public function do_upload($data = array())
	{
        ...
        if ($result)
		{
			...
			return $this->db->insert('log_customer');
		}
	...
	public function do_update($data = array(),$id)
	{
		...
		$update = $this->db->update('customer');
	...
	{
		$del = $this->db->delete('customer', array('id' => $id));
