 ...
 * @version 1.0
 * @access Public
 * @path /bintangtanjuangmadani/application/module_admin/customer/views/customer_view.php
 */
  ...
  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
  	<div class="row">
          ...
          <td style="text-align:center;"> 
            	<a href="<?php echo base_url('customer/cu_action/edit/'.$dt["id"].'');?>" class="fa btn btn-success fa-pencil"></a>
              <button type="button" onclick="deletedata('<?php echo base_url();?>customer/delete/<?php echo $dt['id'];?>')" class="fa btn btn-danger fa-trash"></button>
          </td>
          </tr>
      	<? } ?>
     </tbody>     
	...
	<div class="box-footer">
		<a href="<?php echo base_url('customer/cu_action/add');?>" class="btn btn-primary">Add</a>
	</div>
</section>
