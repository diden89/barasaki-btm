...
<section class="category box">
  ...
  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      ...
      <tbody>
          ...
          <td><?php echo substr($dt['caption_url'], 0,30); ?></td>
          <td class=""><?php echo ($dt['is_active'] == 'Y') ? '<span style="color:green;">Enable</span>':'<span style="color:red;">Disable</span>'; ?></td>
          <td style="text-align:center;"> 
            	<a href="<?php echo base_url('site_map/cu_action/edit/'.$dt["id"].'');?>" class="fa btn btn-success fa-pencil"></a>
            	<button type="button" onclick="deletedata('<?php echo base_url();?>site_map/delete/<?php echo $dt['id'];?>')" class="fa btn btn-danger fa-trash"></a> 
          </td>
          </tr>
      	<? 
	...
	<div class="box-footer">
		<a href="<?php echo base_url('site_map/cu_action/add');?>" class="btn btn-primary">Add</a>
	</div>
</section>
