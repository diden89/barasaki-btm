 ...
 * @version 1.0
 * @access Public
 * @path /bintangtanjuangmadani/application/module_admin/distributor/views/distributor_view.php
 */
...
<section class="distributor box">
	...
	<div class="box-body pad">
		<form id="formInputDistributor" enctype='multipart/form-data'>
			<div class="form-group">
				<label for="txtCaption">Distributor Name:</label>
					<input type="text" class="form-control" id="txtCaption" name="txt_caption" placeholder="Nama Distributor" value='<?php echo (isset($data->caption)) ? $data->caption : ""; ?>' required>
					<input type="hidden" name="txt_id_distributor" id="txt_id_distributor" value="<?php echo (isset($data->id)) ? $data->id : ""; ?>">
			</div>
			<div class="form-group">
	...
	<div class="box-footer">
		...
		<a href='<?php echo base_url("distributor");?>' class="btn btn-warning" id="submitdata">Back</a>
	</div>
		</form>
</section>
